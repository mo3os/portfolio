...
const links = [
  { label: "Email", href: `mailto:${personal.email}`, icon: "M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" },
    ...
    <section id="contact" style={{ padding: "100px 48px 80px", minHeight: "60vh", display: "flex", flexDirection: "column", justifyContent: "center" }}>
      ...
      <FadeIn>
        <h2 style={{
          ...
          Let's work<br />
          <span style={{ WebkitTextStroke: "1px white", color: "transparent" }}>together.</span>
        </h2>
      </FadeIn>
      <FadeIn delay={0.1}>
